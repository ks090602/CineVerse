...
const CardMovies = ({data,mediatype,display})=>{
    ...
    const vote_average = data.vote_average?data.vote_average.toFixed(1):"4.5";
                    ...
                    <figure className = 'video-image'>
                        ...
                        <div className = "circle-rate">
                            <svg className="circle-chart" viewBox="0 0 30 30" width="100" height="100" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <circle className="circle-chart__circle" stroke="#4eb04b" strokeWidth="2" strokeDasharray={`${parseInt(vote_average)}0,100`} cx="15" cy="15" r="14"></circle>
                            </svg>
                            <b>
                                {vote_average}
                            </b>
